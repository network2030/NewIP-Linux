...
with setup_obj.h1:
    ...
    for i in range(0,60,6):
        ...
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,6,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
         
        i += 1
            
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='ipv6', dst_addr='10::2:2', content=f'5--8 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,8,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
            
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='ipv6', dst_addr='10::2:2', content=f'5--10 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,10,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
        ...
        # ipv4 to ipv4
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='ipv4', dst_addr='10.0.2.2', content=f'5--6 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,6,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
        ...
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='ipv4', dst_addr='10.0.2.2', content=f'5--8 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,8,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
        ...
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='ipv4', dst_addr='10.0.2.2', content=f'5--10 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,10,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
        ...
        # ipv4 to 8bit
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='8bit', dst_addr=0b10, content=f'5--6 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,6,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
        ...
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='8bit', dst_addr=0b10, content=f'5--8 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,8,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
        i += 1
        ...
        sender_obj.make_packet(src_addr_type='ipv4', src_addr='10.0.1.2',
                            dst_addr_type='8bit', dst_addr=0b10, content=f'5--10 number: {i}')
        sender_obj.insert_contract(
            contract_type='latency_based_forwarding', params=[5,10,0,3])   #min_delay, max_delay, fib_todelay, fib_tohops
        sender_obj.send_packet(iface='h1_r1', show_pkt=False)
